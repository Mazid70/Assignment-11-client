...
setSearch(value)
    ...
    return (
      ...
      <div className="flex w-full justify-center my-5 "data-aos="fade-up" data-aos-delay="600">
      ...
      <div className="grid grid-cols-2  md:grid-cols-3 lg:grid-cols-6 gap-2 lg:gap-5 mt-10" data-aos="fade-up" data-aos-delay="700">
