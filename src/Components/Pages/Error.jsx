  ...
  return (
    <div className="bg-[#E9FDFF] h-[100vh] flex justify-center items-center">
      <div className="">
        ...
        <p className="text-start font-semibold mt-2">
          The page You are looking for does not Exit or an other error <br />{" "}
          occurred, go back to home page
        </p>
        <div className="flex w-full ">
          <Link
            className="btn justify-items-start mt-5 bg-red-500 text-white "
            to="/"
          >
            Go Home
          </Link>
