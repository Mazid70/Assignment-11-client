...
const SignIn = () => {
  ...
  return (
    <section className="min-h-[100vh] text-white bg-black  flex items-center justify-center w-full overflow-x-hidden">
      ...
      <div className="container mx-auto flex justify-center gap-40">
        ...
        <div className="bg-[#191919] lg:w-[30%] p-10 rounded-lg">
