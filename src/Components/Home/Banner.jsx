      ...
      <div className="container mx-auto">
        <div className="flex  flex-col lg:flex-row h-full  mx-auto items-center lg:gap-40 absolute top-0 p-10 lg:p-0">
          <div className="h-full flex flex-col justify-center lg:w-[55%] gap-8">
            <h1 className="text-3xl lg:text-5xl text-white font-bold " data-aos="fade-right" data-aos-delay="1000">
            ...
            <p className="text-white "data-aos="fade-right" data-aos-delay="2000">
            ...
            <div className="flex justify-between">
              <div className="flex flex-col justify-center items-center gap-1"data-aos="fade-up" data-aos-delay="2200">
              ...
              <div className="flex flex-col justify-center items-center gap-1"data-aos="fade-up" data-aos-delay="2300">
              ...
              <div className="flex flex-col justify-center items-center gap-1"data-aos="fade-up" data-aos-delay="2400">
          ...
          <div className="lg:w-[30%]">
            <img src="burger.png" alt="" className="h-full w-full " data-aos="zoom-in" data-aos-duration="1000"/>
          </div>
        </div>
      </div>
    </section>
