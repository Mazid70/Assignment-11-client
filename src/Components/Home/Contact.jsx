...
const Contact = () => {
  return (
    <section className="container mx-auto text-white mt-10">
      ...
      <div className="flex  flex-col md:flex-row lg:flex-row  gap-10 mt-10 pb-5">
        <div
        ...
        >
          ...
          <button className=" bg-red-500 w-full h-12 rounded-lg">
            Send Massage
          </button>
        </div>
        <div
          className="relative flex-1 mb-96 lg:mb-0 md:mb-0"
          data-aos="fade-left"
          data-aos-delay="600"
        >
          ...
          <div className="flex flex-col md:flex-row  lg:flex-row  justify-center  gap-8  top-1/2 absolute w-full">
            <div
